...
class MineSweeperView(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        // We calculate the cell size based on the screen size and the desired cells
        ...
        // Download and scale the flag image
    ...
    private fun revealCell(x: Int, y: Int) {
        ...
        if (cell.isMine) {
            ...
            // Checking that the cell has not been opened before
            if (!cell.isRevealed) {
    ...
    private  fun checkWinCondition() {
        ...
        if (revealedCount == boardWidth * boardPixelHeight - mineCount) {
            // The game is won
            cells.forEach { row ->
                row.forEach { c ->
                    c.isRevealed = true
